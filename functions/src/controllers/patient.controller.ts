...
export class PatientController {
    ...
    createPatient = asyncHandler(async (req: Request, res: Response) => {
        ...
        return res.status(200).json(
            new CustomResponse(true, "Patient created successfully", {
                id: patientId,
            })
        );
    });
    ...
    updatePatient = asyncHandler(async (req: Request, res: Response) => {
        ...
        return res
            .status(200)
            .json(new CustomResponse(true, "Patient updated successfully", {}));
    });
    ...
    deletePatient = asyncHandler(async (req: Request, res: Response) => {
        ...
        return res
            .status(200)
            .json(new CustomResponse(true, "Patient deleted successfully", {}));
    });
}
