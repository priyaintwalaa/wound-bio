...
export class OrderController {
    ...
    createOrder = asyncHandler(async (req: Request, res: Response) => {
        ...
        return res.status(200).json(
            new CustomResponse(true, "order created succesfully", {
                id: order.id,
            })
        );
    });
    ...
    updateOrder = asyncHandler(async (req: Request, res: Response) => {
        ...
        return res
            .status(200)
            .json(new CustomResponse(true, "order updated succesfully", {}));
    });
    ...
    deleteOrder = asyncHandler(async (req: Request, res: Response) => {
        ...
        return res
            .status(200)
            .json(new CustomResponse(true, "order deleted succesfully", {}));
    });
}
